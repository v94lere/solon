fn main() {
    ...
    // Solon : cette vérification testait l'OS de la machine qui compile, pas la cible ; elle
    // empêchait la compilation croisée Windows → Linux (musl). La cible est vérifiée par Cargo.
