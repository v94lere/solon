  ...
  useEffect(() => {
    ...
    dockerEvents
      .subscribe((ev) => {
        ...
        // Un conteneur qui meurt avec un code non nul, sans action de l'utilisateur dans l'application.
        if (ev.type === "container" && ev.action === "die" && ev.exit_code && ev.exit_code !== "0" && !recentlyActed(ev.id)) {
