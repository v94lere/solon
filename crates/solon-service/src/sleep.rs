//! Réveil à la demande : un conteneur qui a déjà reçu du trafic par Solon (domaine `*.solon.local`
...
//!
//! Garde-fous : seuls les conteneurs ayant déjà reçu une connexion via Solon sont concernés (jamais
...
use solon_core::protocol::{Command, ContainerEndpoint, ExecResult};
...
struct State {
    ...
    /// Conteneurs mis en pause par Solon (identifiants).
...
impl Sleeper {
    ...
    /// Identifiants des conteneurs endormis par Solon.
