//! Document JSON de configuration HCS (schéma v2.x), limité aux champs utilisés par Solon.
//!
...
impl ComputeSystemDocument {
    /// Construit le document HCS d'une machine Solon.
...
mod tests {
    use super::*;
    use solon_core::vm::DiskAttachment;
    ...
    fn config() -> VmConfig {
        VmConfig {
            ...
            name: "solon".into(),
            kernel: PathBuf::from(r"C:\ProgramData\Solon\image\vmlinuz"),
            initrd: PathBuf::from(r"C:\ProgramData\Solon\image\initrd.img"),
    ...
    fn enumeration_se_desserialise() {
        let raw = r#"[{"Id":"abc","SystemType":"VirtualMachine","Owner":"Solon","RuntimeId":"x","State":"Running"}]"#;
